    ...
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-toolbar">
            ...
            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                <!--begin::Add user-->
                <button type="button" class="btn btn-light-info" data-bs-toggle="modal" data-bs-target="#modal-aluno">
                ...
                <!--end::Svg Icon-->Cadastrar Aluno</button>
                <!--end::Add user-->
            </div>
            <!--end::Toolbar-->
            <!--begin::Group actions-->
                    ...
                    <tr>
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                <a href="#">
                                    <div class="symbol-label">
                                        <div class="symbol-label fs-3 bg-light-success text-success">{{$aluno->name[0]}}</div>
                                    </div>
                                </a>
                            </div>
                            <!--end::Avatar-->
                            ...
                            <div class="d-flex flex-column">
                                <a href="#" class="text-gray-800 text-hover-success mb-1">{{$aluno->name}}</a>
                        ...
                        <!--begin::Last login=-->
                        <td>
                            <div class="badge badge-light fw-bold">{{$aluno->registration}}</div>
                        </td>
                        <!--end::Last login=-->
                        <!--begin::Two step=-->
                        <!--end::Two step=-->
                        ...
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-90px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <button class="menu-link px-3 btn btn-custom w-65px" data-bs-toggle="modal" data-bs-target="#modal-edit-aluno" onclick="editAluno('{{route('alunos.update', $aluno)}}', '{{$aluno->name}}', '{{$aluno->email}}', '{{$aluno->cpf}}', '{{$aluno->registration}}');">Editar</button>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
